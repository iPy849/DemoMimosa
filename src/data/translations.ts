...
export const translations = {
  es: {
    ...
    "contact.page.how": "¿Cómo podemos ayudarte?",
    "contact.page.desc": "Estamos aquí para asesorarte en tu próxima gran inversión. Ya sea que busques una residencia vacacional o diversificar tu portafolio, nuestro equipo está a tu disposición.",
    "contact.page.email": "Email",
    "contact.page.phone": "Teléfono",
