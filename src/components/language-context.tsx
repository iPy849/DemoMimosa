...
const translations = {
  es: {
    ...
    "about.history_p1": "MIMOSA Developments nació de la visión de transformar el mercado inmobiliario del Caribe Mexicano, elevándolo a estándares internacionales de lujo y exclusividad sin precedentes.",
    ...
    "about.quote": "En MIMOSA Developments, no vendemos propiedades, entregamos legados. Cada proyecto en nuestro portafolio ha sido seleccionado por su diseño arquitectónico superior y ubicación estratégica.",
