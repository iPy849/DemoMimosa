...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 bg-foreground text-background px-3 py-1 rounded-md text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
